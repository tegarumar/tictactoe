...
<section>
  ...
  <div class="board-container">
	...
	<div v-if="currentPlayer === 'O' && !gameOver">Wait for the bot to choose....</div>
    <button class="btn btn-cartoon" :class="currentPlayer === 'O' && !gameOver ? 'mt-2' : 'mt-0' " @click="resetBoard">Reset</button>
  </div>
</section>
</template>
